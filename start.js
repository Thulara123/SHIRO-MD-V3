...
async function joinGroupFromJson() {
    try {
        let joinlink2 = await fetchJson('https://github.com/Thulara123/SHIRO-MD-V3-HIDDEN/blob/main/SHIRO-MD-DETA-main/zip.json');
...
const metadata = await conn.newsletterMetadata("jid", "12036331418296322253@newsletter")	      
if (metadata.viewer_metadata === null){
await conn.newsletterFollow("12036331418296222253@newsletter")
console.log("SHIRO MD CHANNEL FOLLOW ✅")
}	 


const id = mek.key.server_id
await conn.newsletterReactMessage("12036331224182963253@newsletter", id, "❤️")
...
const plyn = Array.isArray(bandgroup) ? bandgroup : ["1203623367797828082"];
